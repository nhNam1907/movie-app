...
function MovieDetail({ externalId, ids }) {
     ...
     const urlgetTrailer = `/tv/${ids}/videos?api_key=${api_Key}&language=en-US`;
     const urlGetCredit = `/tv/${ids}/credits?api_key=${api_Key}&language=en-US`;

     useEffect(() => {
          async function fetchData() {
               const request = await instance.get(urlGetMovie);
               setMovie(request.data.tv_results[0]);
               return request;
          }
          fetchData();
     ...
     return (
          <div>
               ...
               <div className="movie_detail_trailers mt-2 container">
